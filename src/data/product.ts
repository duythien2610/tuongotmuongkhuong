...
export const PRODUCT_VARIANTS: ProductVariant[] = [
  ...
  },
  {
    ...
    originalPrice: 80000,
    image: IMG.sauce2,
    description: 'Chai nhựa truyền thống, bảo quản tốt hơn, dung tích lớn tiết kiệm',
    stock: 89,
  },
];
...
export const ALL_PRODUCTS: Product[] = [
  ...
  {
    id: 'sauce-250',
    name: 'Tương Ớt Truyền Thống 250ml',
    category: 'tuong-ot',
    categoryLabel: 'Tương ớt',
    price: 30000,
    originalPrice: 45000,
    image: IMG.sauce1,
    description: 'Tương ớt truyền thống từ ớt thóc tươi, vị cay nồng đậm đà, chua nhẹ tự nhiên, màu đỏ tự nhiên 100%. Chai nhựa 250ml tiện lợi.',
    rating: 4.9, reviews: 128, sold: 250, stock: 156,
    badge: 'Chai nhựa', badgeVariant: 'new',
    weight: '250ml',
    featured: true,
    slug: 'tuong-ot-truyen-thong-250ml',
  },
  {
    id: 'sauce-500',
    name: 'Tương Ớt Truyền Thống 500ml',
    category: 'tuong-ot',
    categoryLabel: 'Tương ớt',
    price: 55000,
    originalPrice: 80000,
    image: IMG.sauce2,
    description: 'Tương ớt truyền thống từ ớt thóc tươi, vị cay nồng đậm đà, chua nhẹ tự nhiên, màu đỏ tự nhiên 100%. Chai nhựa 500ml tiết kiệm.',
    rating: 4.9, reviews: 94, sold: 180, stock: 89,
    badge: 'OCOP 3 Sao', badgeVariant: 'ocop',
    weight: '500ml',
    featured: true,
    slug: 'tuong-ot-truyen-thong-500ml',
  },
];
